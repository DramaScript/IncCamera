 ...
 */
public class PusherCameraHelper implements SurfaceHolder.Callback, Camera.PreviewCallback {
    ...
    public PusherCameraHelper(Activity activity, int cameraId, int width, int height) {
        mActivity = activity;
        mCameraId = cameraId;
        mWidth = width;
        mHeight = height;
